...
public class TransactionsList extends ListActivity {
    ...
    private static final String[] PROJECTION_ACCOUNT = new String[] { Budgets.Accounts.TITLE, // 0
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getData() == null) {
            ...
            mAccountCursor = managedQuery(
                    ContentUris.withAppendedId(Budgets.Accounts.CONTENT_URI, Long.valueOf(accountId)),
    ...
    private void refresh() {
        ...
        if (mAccountCursor.getCount() > 0) {
            ...
            amount = mAccountCursor.getFloat(PROJECTION_ACCOUNT_AMOUNT);
            spend = mAccountCursor.getFloat(PROJECTION_ACCOUNT_SPEND);
        }
        mProgressBar.setVisibility(View.GONE);
        if (spend > 0 && amount > 0) {
            if (amount > spend) {
                mProgressBar.setVisibility(View.VISIBLE);
                mProgressBar.setProgress((int) ((spend * 100) / amount));
            }
            setTitle(getResources().getString(R.string.title_transactions_list_balance,
                    NumberFormat.getCurrencyInstance().format(spend),
                    NumberFormat.getCurrencyInstance().format(amount), title));
        } else if (amount > 0) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_ITEM_INSERT, 0, R.string.menu_transaction_insert).setShortcut('3', 'a')
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0, new ComponentName(this, TransactionsList.class), null,
                intent, 0, null);
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
        ...
        menu.setHeaderTitle(title.length() > 0 ? title : getResources().getString(
                R.string.transaction_contextMenu_title));
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_DELETE: {
            ...
            new AlertDialog.Builder(TransactionsList.this).setTitle(R.string.deleteConfirmation_title)
                    .setIcon(android.R.drawable.ic_dialog_alert).setMessage(R.string.transaction_deleteConfirmation)
